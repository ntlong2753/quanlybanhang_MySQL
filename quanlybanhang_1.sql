...
INSERT INTO `customer` VALUES (1,'Minh Quan',35),(2,'Ngoc Oanh',20),(3,'Hong Ha',50),(4,'Quang Huu',23);
...
INSERT INTO `order` VALUES (1,1,'2026-03-21',NULL),(2,2,'2026-03-23',NULL),(3,1,'2026-03-16',NULL),(4,2,'2026-03-25',NULL);
...
CREATE TABLE `product` (
  `pID` int NOT NULL,
  `pName` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL,
...
INSERT INTO `product` VALUES (1,'Máy giặt',3),(2,'Tủ lạnh',5),(3,'Điều hòa',7),(4,'Quạt',1),(5,'Bếp điện',2);
...
-- Dump completed on 2026-03-25  9:58:52
